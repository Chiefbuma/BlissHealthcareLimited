...
def home():
    ...
    if st.session_state.is_authenticated:
        ...
        if connection.is_connected():
            ...
            fig.add_trace(
                go.Indicator(
                    title=dict(text="PERFORMANCE INDEX", font=dict(size=15,color='green') ),
                    mode="delta",
       ...
       #st.write(second_last_performance_value, second_last_date_value )
            ck1,ck2,ck3,ck5,ck6 = st.columns([2.5, 2.5,2.5,2.5,5])
            ...
            fig_request_by_type_ff = go.Figure(data=[go.Table(
                        header=dict(values=['Scheme','MTD_Budget_Footfall','MTD_Actual_Footfall','%Arch_FF','Total_Footfall_Budget','Projected_Footfalls'],
            ...
            fig_request_by_type_Rev = go.Figure(data=[go.Table(
                header=dict(values=['Scheme','MTD_Budget_Revenue','MTD_Actual_Revenue','%Arch_REV','Total_Revenue_Budget','Projected_Revenue'],
                            fill_color='rgba(0, 84, 0, 1)',
                            align='left',
                            font=dict(color='White', size=18),
                            line_color='darkslategray',  # Border color
