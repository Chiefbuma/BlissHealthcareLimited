...
def app():
    ...
    if st.session_state.is_authenticated:
        ...
        if init_connection():
            ...
            projected_revenue =Total_Budget_Reveneu*(MTD_Actual_Revenue/MTD_Revenue_budget)
            ...
            projected_Footfall = formatted_Total_footfall*(MTD_Actual_Footfall/MTD_footfall_budget)
