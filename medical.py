...
,
            ...
            with card_container(key="MTDREVENUE"):
                ...
                with card_container(key="MTDclinic"):
                    ...
                    metabase_base_url = "http://localhost:3000/public/dashboard/30e28005-ae57-4a4f-bf59-560b1e21d2cb"
                    ...
                    with container:
                        ...
                        iframe_code = """
                        <iframe
                            src="http://localhost:3000/public/dashboard/30e28005-ae57-4a4f-bf59-560b1e21d2cb"
                            frameborder="0"
                            width="800"
                            height="600"
