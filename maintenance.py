    ...
    if st.session_state.is_authenticated:
        ...
        data = [
            {"Approver": "Director", "Approved No.":Dir_Approved_request, "Approved Value":Dir_Approved_value, "Pending Requets":Dir_pending_request, "Pending Value":Dir_pending_value },
             {"Approver": "Projects", "Approved No.":Pro_Approved_request, "Approved Value":Pro_Approved["Approved amount"].sum(), "Pending Requets":Pro_pending_request, "Pending Value":Pro_pending_value },
