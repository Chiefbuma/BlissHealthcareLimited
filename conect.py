...
import main, region,medical,nyumbani,maintenance,Radiology,Repair,Finance,Operations
...
class MultiApp:
    ...
    def run():
        ...
        with st.sidebar: 
            ...
            options=['Account','Medical centre', 'Region','Dawa Nyumbani','Maintenance','Radiology','Finance','Operations'],
