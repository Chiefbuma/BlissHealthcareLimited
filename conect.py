...
import main, region,medical,nyumbani,maintenance,Radiology,Repair,Finance
...
class MultiApp:
    ...
    def run():
        ...
        with st.sidebar: 
            ...
            options=['Account','Medical centre', 'Region','Dawa Nyumbani','Maintenance','Radiology','Finance'],
            icons=['house-fill', 'receipt', 'receipt', 'receipt', 'receipt','receipt','receipt','person-circle'],
