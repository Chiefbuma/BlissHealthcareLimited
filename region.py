    ...
    if st.session_state.is_authenticated:
        ...
        if init_connection():
            ...
            with card_container(key="MTDclinic"):
                ...
                SHAREPOINT_URL = "https://blissgvske.sharepoint.com/:u:/r/sites/Accreditationcommunicationsite/SitePages/Home.aspx?csf=1&web=1&share=EVCn7lO03I1NqALsNTvbtpEBSQC_MM0sx-_caVL36vBb3Q&e=QOsFbh"

                # Embed the SharePoint site using an iframe
                st.markdown(
                    f'<iframe src="{SHAREPOINT_URL}" width="100%" height="800" frameborder="0" allowfullscreen></iframe>',
